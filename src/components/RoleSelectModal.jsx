...
/**
 * First-time role picker. Shown when the user has signed in but has not yet
 * set profile.role (role_chosen_at is null). On confirm: writes role +
 * role_chosen_at, closes, and navigates to the matching dashboard.
 */
    ...
    <div className="fixed inset-0 z-[110] flex items-center justify-center p-4" role="dialog" aria-modal="true">
      ...
      <div className="relative w-full max-w-2xl rounded-3xl border border-white/10 bg-ink-900 shadow-glow p-6 md:p-10">
        <div className="text-center">
          ...
          <p className="mt-1 text-[11px] text-white/40">You can change or add the other role any time from your dashboard.</p>
        </div>
